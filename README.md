...
* **Testing Methodologies:** Black Box Testing, Attack Vector Analysis
* **Documentation:** Technical Security Reporting, Presentation Delivery

---

## 🚀 Capstone Project: Black Box Hacking Simulation
...
* 📄 **Presentation:** [Download Capstone Presentation](./Presentation.pdf) *(Note: Ensure your presentation file is uploaded to this repository and update this link path if needed)*
